...
public abstract class CutterMigration extends Migration {
    ...
    public static void update3(final MigrationContext context) {
        context.remove("extensions.blockylog");
    }

    public static void update5(final MigrationContext context) {
        context.move("options.cutter.permissions", "options.cutter.permission.wood-type");
    }

    public static void update8(final MigrationContext context) {
