...
public final class Storage {
    ...
    public static final AbstractReflect UNBREAKABLE = createOptional(META_SPIGOT.getMethod("spigot").getDeclaringClass())
        .searchMethod("unbreakable", "isUnbreakable");

    private static Reflect createOptional(final Class<?> clazz) {
        if (clazz == null) {
            return SELF;
        }
